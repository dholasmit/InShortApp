...
RecentlyAddedProductsModel recentlyAddedProductsModelFromJson(String str) =>
    RecentlyAddedProductsModel.fromJson(json.decode(str));

String recentlyAddedProductsModelToJson(RecentlyAddedProductsModel data) =>
    json.encode(data.toJson());

class RecentlyAddedProductsModel {
  int? status;
  String? message;
  List<Datum>? data;
  ...
  factory RecentlyAddedProductsModel.fromJson(Map<String, dynamic> json) =>
      RecentlyAddedProductsModel(
        status: json["Status"],
